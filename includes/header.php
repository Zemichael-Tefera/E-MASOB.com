 <!--**********************************
        ...
        ***********************************-->
        ...
        <div class="nav-header">
			...
			<img class="logo-abbr" src="assets/images/favicon.png" width="197px" alt="">
			<img class="brand-title" src="assets/images/halfLogo.png" width="197px" alt="">
								...
								<div class="nav-item d-flex align-items-center">
									<div class="d-flex header-bx">									
										<select class="selectpicker">
											  <option data-icon="fa-solid fa-location-dot mx-2"><a href="./kkRestaurant.php">ኬኬ Green ሬስቶራንት</a></option>
											  <option data-icon="fa-solid fa-location-dot mx-2">ኬኬ yellow ሬስቶራንት</option>
											  <option data-icon="fa-solid fa-location-dot mx-2">ክብ ነሽ ሬስቶራንት 1</option>
											  <option data-icon="fa-solid fa-location-dot mx-2">ክብ ነሽ ሬስቶራንት 2</option>
											  <!-- <option data-icon="fa-solid fa-location-dot mx-2">Block 5</option> 
											  <option data-icon="fa-solid fa-location-dot mx-2">Block 6</option> 
											  <option data-icon="fa-solid fa-location-dot mx-2">Block 7</option>
											  <option data-icon="fa-solid fa-location-dot mx-2">Block 8</option>
											  <option data-icon="fa-solid fa-location-dot mx-2">Block 9</option> -->
										</select>
									...
									<div class="dropdown header-profile2 ">
										<a class="nav-link " href="javascript:void(0);"  role="button" data-bs-toggle="dropdown">
											<div class="header-info2 d-flex align-items-center">
												<img src="assets/images/no-img-avatar.png" alt="">
												<div class="d-flex align-items-center sidebar-info">
													<div>
														<h6 class="font-w500 mb-0 ms-2">አቶ አበበ ከበደ</h6>
													</div>	
